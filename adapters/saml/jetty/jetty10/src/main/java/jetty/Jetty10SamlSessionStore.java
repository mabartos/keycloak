 ...
 * @version $Revision: 1 $
 */
public class Jetty10SamlSessionStore extends JettySamlSessionStore {
    public Jetty10SamlSessionStore(Request request, AdapterSessionStore sessionStore, HttpFacade facade, SessionIdMapper idMapper, JettyUserSessionManagement sessionManagement, SamlDeployment deployment) {

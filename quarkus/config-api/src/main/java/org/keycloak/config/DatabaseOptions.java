...
public class DatabaseOptions {
    ...
    public static final class Datasources {
        ...
        /**
         * Check if the {@code name} is the requested datasource wildcard {@code option}.
         *
         * @param name   checked name
         * @param option datasource option
         */
        public static <T> boolean isDatasourceOption(String name, Option<T> option) {
            return name.startsWith(option.getKey().concat(DATASOURCES_OVERRIDES_SUFFIX.getOrDefault(option.getKey(), "")));
        }

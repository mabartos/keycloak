...
public class LoggingOptions {
    ...
    public static final Boolean GELF_ENABLED = isGelfEnabled();
    ...
    public static List<String> getAvailableHandlerNames() {
        final Predicate<Handler> checkGelf = (handler) -> GELF_ENABLED || !handler.equals(Handler.gelf);
    ...
    private static boolean isGelfEnabled() {
        try {

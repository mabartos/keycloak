...
public class LoggingOptions {
    ...
    public static final Option<Level> LOG_SYSLOG_LEVEL = new OptionBuilder<>("log-syslog-level", Level.class)
            ...
            .description("Set the log level specifying which message levels will be logged by the Syslog logger. Message levels lower than this value will be discarded.")
            .build();

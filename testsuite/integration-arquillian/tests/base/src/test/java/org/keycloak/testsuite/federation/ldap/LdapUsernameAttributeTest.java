...
public class LdapUsernameAttributeTest extends AbstractLDAPTest {
    ...
    public void testUsernameChangeAlreadyExists() {
        ...
        try {
             ...
             Assertions.assertFalse("Model exception is expected here, so it should not reach this point", true);
         } catch (RunOnServerException e) {
             Assertions.assertTrue("Model exception is expected here but another error found", e.getCause() instanceof ModelDuplicateException);

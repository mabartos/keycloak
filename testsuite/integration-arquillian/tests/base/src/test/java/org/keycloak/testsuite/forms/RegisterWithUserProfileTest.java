...
public class RegisterWithUserProfileTest extends RegisterTest {
    ...
    public static void assertFieldTypes(WebDriver driver) {
        ...
        Assertions.assertEquals("default empty option is missing in select","", driver.findElement(By.cssSelector("select#selectWithOptionsWithoutLabels option[value='']")).getText());

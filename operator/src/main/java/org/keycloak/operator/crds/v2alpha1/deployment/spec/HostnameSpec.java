...
public class HostnameSpec implements Serializable {
    ...
    @JsonPropertyDescription("Set the base URL for frontend URLs, including scheme, host, port and path.")
    private String url;

    @JsonPropertyDescription("The port used by the proxy when exposing the hostname.")
